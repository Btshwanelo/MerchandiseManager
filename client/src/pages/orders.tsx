          ...
          {selectedOrder && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">
                    ORD-{selectedOrder.id.toString().padStart(4, "0")}
                  </p>
                </div>
                <div>
                  ...
                  selectedOrder.status === "completed" ? (
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {new Date(
                            selectedOrder.orderDate.getTime() + 86400000
                          ).toLocaleString()}
                        </p>
                      </div>
                    </div>
                  ...
                  {selectedOrder.status === "completed" ? (
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {new Date(
                            selectedOrder.orderDate.getTime() + 172800000
                          ).toLocaleString()}
                        </p>
                      </div>
                    </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {selectedOrder.pictures &&
                    selectedOrder.pictures.map((pic: string, index: number) => (
                      <div
                        key={index}
                        className="border rounded-md h-20 bg-muted/20 flex items-center justify-center overflow-hidden"
                      >
                        <img
                          src={pic}
                          alt={`Order ${index + 1}`}
              ...
              {user &&
                ...
                selectedOrder.status === "submitted" && (
                  <div className="mt-6 bg-muted/20 rounded-md p-4 space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      As a manager or admin, you can approve or reject this
                      order.
                    </p>
              ...
              {user &&
                ...
                selectedOrder.status === "processing" && (
                  <div className="mt-6 bg-muted/20 rounded-md p-4 space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Mark this order as completed when it has been fulfilled.
                    </p>
                    <div className="flex gap-2 mt-2">
                      <Button
                        size="sm"
